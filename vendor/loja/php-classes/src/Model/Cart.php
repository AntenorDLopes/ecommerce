<?php 
	...
	class Cart extends Model
	{
		...
		public static function getFromSession() // OK
		{
			$cart = new Cart();
		...
		public function setToSession() // OK
		{
			$_SESSION[Cart::SESSION] = $this->getValues();
		}

		public function getFromSessionID() // OK
		{
		...
		public function get(int $idcart) // OK
		{
		...
		public function addProduct(Product $product) // OK
		{
			$sql = new Sql();
		...
		public function removeProduct(Product $product, $all = false) // OK
		{
			$sql = new Sql();
		...
		public function setFreight($nrzipcode) // CONFIGURAR FRETE 
		{
