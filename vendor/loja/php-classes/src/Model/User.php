<?php 
	...
	{
		const SESSION = "User";
		const SECRET = "LojaVirtual_@@98";
		const SECRET_IV = "LojaVirtual_@@98";
	...
	public static function login($login, $password)
	{
		...
		public static function getForgot($email, $inadmin = true) // MELHORAR TRATAR ERROR
		{
			$sql = new Sql();
			...
			{	
				...
				$mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da LojaVirtual", "forgot", array(
					"name"=>$data['desperson'],
					"link"=>$link
				));				
				$mailer->send();
